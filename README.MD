...
En el caso de desear usar la integracion a firebase use la key "firebase" y en el caso de querer usar la integración a mongoDB use la key "mongo" en la variable APP_DATABASE_TO_USE
